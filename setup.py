...
setup(
    # 指定项目名称，我们在后期打包时，这就是打包的包名称，当然打包时的名称可能还会包含下面的版本号
    name="pql_rl",
    # 指定版本号
    version="0.1.1",
    # 这是对当前项目的一个描述
    description="QilongPan reinforcement learning ",
    # 作者是谁，指的是此项目开发的人，这里就写你自己的名字即可
    author="panqilong",
    # 作者的邮箱
    author_email="3102377627@qq.com",
    # 写上项目的地址，比如你开源的地址开源写博客地址，也开源写GitHub地址，自定义的官网地址等等。
    url="https://github.com/QilongPan/pql_rl.git",
